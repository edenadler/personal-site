...
const _require3 = require(`./create-file-node`),
      createFileNode = _require3.createFileNode;

const _require4 = require(`./utils`),
      getRemoteFileExtension = _require4.getRemoteFileExtension,
      getRemoteFileName = _require4.getRemoteFileName;
